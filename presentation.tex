...
\begin{frame}[allowframebreaks=0.8]
  ...
  \begin{itemize}
    ...
    \item L'humanité est dépendante de ce grand système, mais alors que
      l'espèce humaine n'a jamais eu autant de \al{pouvoir} pour façonner le monde
      physique à l'échelle planétaire, ce même pouvoir, lorsqu'il n'est pas
      considéré avec \al{prudence} et qu'il ignore le \al{bien commun présent et futur},
    ...
    \item Alors que les graves conséquences du dépassement des limites
      ...
      \al{relations plus collaboratives et constructives} entre ses peuples et avec
      l'environnement naturel.
    \item Aujourd'hui, nous devons agir beaucoup plus rapidement et à plus
      grande échelle, en \al{modifiant l'organisation et le fonctionnement des
...
\begin{frame}[allowframebreaks=0.8]
  ...
  \begin{itemize}
    \item Vue de la planète entière, l'humanité est un seul peuple vivant dans
      une seule patrie mondiale. La conscience de cette \al{unité}, en appliquant la
      \al{justice}, est le seul \al{fondement} sur lequel des sociétés durables peuvent
      être créées.
    ...
    \item L'unité de l'humanité comprend des variations d'expression, de culture
      ou d'organisation sociale, ce que nous appelons \al{l'unité dans la diversité}.
    ...
    \item Dans les affaires humaines, la diversité de pensée, d'origine et
      d'approche est tout aussi importante. \al{La vérité naît de l'interaction de
    ...
    \item Les contributions de beaucoup plus de personnes sont nécessaires pour
      rééquilibrer notre relation avec le monde naturel. \al{La présomption de
      ...
      \al{empêche le consensus et l'action coordonnée, et sape la motivation à
